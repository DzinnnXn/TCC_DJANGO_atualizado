...
from .views import get_salas
from .views import get_inventarios
from .views import add_inventario
...
urlpatterns = [
        ...
        path('api/salas/', get_salas, name='get_salas'),
        path('api/inventarios/', get_inventarios, name='get_inventarios'),
        path('api/add_inventario/', add_inventario, name='add_inventario'),
